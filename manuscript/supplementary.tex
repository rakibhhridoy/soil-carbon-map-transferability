...
\PLACE{AGB-C labels were sampled from the 30~m Simard product within each delta's
mangrove mask (500 points per delta; AGB$\to$C $\times0.47$) and run through the
identical models, validation tiers, AOA and conformal machinery as SOC. Report the
full per-delta AGB LODO table and the per-delta total-carbon breakdown.}
